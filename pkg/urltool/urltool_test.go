...
func TestGetBasePath(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "相对路径url", args: args{targetUrl: "/xxx/123"}, want: "", wantErr: true},
		{name: "空字符串", args: args{targetUrl: ""}, want: "", wantErr: true},
		{name: "带query的url", args: args{targetUrl: "https://www.liwenzhoou.com/posts/Go/golang-menu/?a=1&b=2"}, want: "golang-menu", wantErr: false},
	}
